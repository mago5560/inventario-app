...
export class EmpresaComponent implements OnInit {
  ...
  public _datos:Empresa[]=[];
  public _descripcion:string="";

  constructor(private service:EmpresaService,private router: Router,public rutaActiva: ActivatedRoute,private toastr: ToastrService,private modalService: NgbModal) { }
  ...
  modificar(data:Empresa){
    this.router.navigate(['./tecleo',data.idEmpresa], { relativeTo: this.rutaActiva });
  }

  
  openDialog(modalEliminar,data:Empresa) {
    this.modalService.open(modalEliminar, {ariaLabelledBy: 'modal-basic-title'}).result.then((result) => {
      //Aceptar
      this.service.eliminar(data.idEmpresa).subscribe(data => {       
