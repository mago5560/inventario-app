...
export class ProveedorComponent implements OnInit {
  ...
  constructor(private service:ProveedorService,private router: Router,public rutaActiva: ActivatedRoute,private toastr: ToastrService,private modalService: NgbModal) { }
  ...
  modificar(data:Proveedor){
    this.router.navigate(['./tecleo',data.idProveedor], { relativeTo: this.rutaActiva });
  }

  
  openDialog(modalEliminar,data:Proveedor) {
    this.modalService.open(modalEliminar, {ariaLabelledBy: 'modal-basic-title'}).result.then((result) => {
      //Aceptar
      this.service.eliminar(data.idProveedor).subscribe(data => {       
